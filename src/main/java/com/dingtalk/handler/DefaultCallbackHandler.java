...
public class DefaultCallbackHandler implements CustomCallbackHandler {
    ...
    private CardCallbackResponse.CardDataDTO updateCardData(String status) {
        ...
        cardData.getCardParamMap().put("title", "回调回复测试title");
        cardData.getCardParamMap().put("createTime", "回调回复测试createTime");
        cardData.getCardParamMap().put("type", "回调回复测试type");
        cardData.getCardParamMap().put("reason", "回调回复测试reason");
        cardData.getCardParamMap().put("lastMessage", "回调回复测试lastMessage");
